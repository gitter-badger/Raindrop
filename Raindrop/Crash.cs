...
namespace Raindrop
{
    public class Crash
    {
        ...
        public static void StopKernel(Exception ex)
        {
            ...
            Console.WriteLine("An error occured in Raindrop Operating System:");
            ...
            Console.WriteLine("Raindrop Version: " + Kernel.version);
            Console.WriteLine("Raindrop Revision: " + Kernel.revision);
            Console.WriteLine();
            ...
            Console.WriteLine();
            Console.WriteLine(@"If problems continue, you can submit your issue on our 
GitHub repository (github.com/KrasnotR/Raindrop).");
            Console.WriteLine();
        ...
        public static void StopKernel(string exception, string description, string lastknowaddress, string ctxinterrupt)
        {
            ...
            Console.WriteLine("CPU Exception x" + ctxinterrupt + " occured in Raindrop Operating System:");
